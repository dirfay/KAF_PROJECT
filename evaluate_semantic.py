...
def load_eval() -> list[dict[str, Any]]:
    ...
    if not isinstance(data, list):
        raise TypeError(
            "Очікувався список тестових запитів "
            "у retrieval_eval.json."
        )
...
def main() -> None:
    ...
    print("=" * 80)
    print("SEMANTIC RETRIEVAL EVALUATION — E2")
    print("=" * 80)
    ...
    summary = {
        "version": "E2",
        "method": "Dense Semantic Retrieval",
